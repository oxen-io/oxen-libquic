...
namespace oxen::quic::test
{
    ...
    TEST_CASE("008 - Connection Hooks", "[008][conn][open][callbacks]")
    {
        ...
        auto client_closed = callback_waiter{[&client_error](Connection&, uint64_t ec) { client_error = ec; }};
        auto server_closed = callback_waiter{[&server_error](Connection&, uint64_t ec) { server_error = ec; }};
