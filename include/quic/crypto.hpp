...
namespace oxen::quic
{
    ...
    struct GNUTLSCert : TLSCert
    {
        ...
        explicit GNUTLSCert(std::string server_key, std::string server_cert) : keyfile{server_key}, certfile{server_cert}
        {
    ...
    struct GNUTLSContext : TLSContext
    {
      ...
      private:
        ...
        int config_client_certs(GNUTLSCert& cert);
    };
    ...
    inline std::shared_ptr<TLSContext> GNUTLSCert::into_context() &&
    {
