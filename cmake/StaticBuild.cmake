...
build_external(nettle
    CONFIGURE_COMMAND ./configure ${build_host} --disable-shared  --prefix=${DEPS_DESTDIR} --libdir=${DEPS_DESTDIR}/lib
        --enable-pic --disable-openssl --disable-documentation --enable-mini-gmp --without-idn
        "CC=${deps_cc}" "CXX=${deps_cxx}"
...
build_external(gnutls
    CONFIGURE_COMMAND ./configure ${build_host} --disable-shared --with-nettle-mini  --with-included-unistring   --prefix=${DEPS_DESTDIR} --with-pic --with-included-libtasn1
